...
public sealed class TimerService : IHostedService, IAsyncDisposable
{
    ...
    private readonly State _state = new State(new ("server=127.0.0.1;uid=root;pwd=Dunder123!1;database=Globetrotter;port=3306"));
    private readonly State _state1 = new State(new("server=127.0.0.1;uid=root;pwd=Dunder123!1;database=Globetrotter;port=3306"));
